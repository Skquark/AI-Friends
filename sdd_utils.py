...
AIHorde_models = ["3DKX", "Abyss OrangeMix", "AbyssOrangeMix-AfterDark", "ACertainThing", "AIO Pixel Art", "AlbedoBase XL (SDXL)", "Analog Diffusion", "Animagine XL", "Anime Pencil Diffusion", "Anygen", "Anything Diffusion", "Anything v3", "App Icon Diffusion", "Arcane Diffusion", "Archer Diffusion", "Asim Simpsons", "A to Zovya RPG", "Balloon Art", "BB95 Furry Mix", "Borderlands", "BPModel", "BRA", "BubblyDubbly", "Char", "CharHelper", "Cheese Daddys Landscape Mix", "ChilloutMix", "ChromaV5", "Classic Animation Diffusion", "Clazy", "Colorful", "Coloring Book", "Comic-Diffusion", "Concept Sheet", "Counterfeit", "Cyberpunk Anime Diffusion", "CyriousMix", "Dan Mumford Style", "Darkest Diffusion", "Dark Victorian Diffusion", "Deliberate", "DGSpitzer Art Diffusion", "Disco Elysium", "DnD Item", "Double Exposure Diffusion", "Dreamlike Diffusion", "Dreamlike Photoreal", "DreamLikeSamKuvshinov", "Dreamshaper", "DreamShaper XL", "DucHaiten", "DucHaiten Classic Anime", "Dungeons and Diffusion", "Dungeons n Waifus", "Eimis Anime Diffusion", "Elden Ring Diffusion", "Elldreth's Lucid Mix", "Elldreths Retro Mix", "Epic Diffusion", "Eternos", "Experience", "ExpMix Line", "FaeTastic", "Fantasy Card Diffusion", "FKing SciFi", "Funko Diffusion", "Furry Epoch", "Future Diffusion", "Ghibli Diffusion", "GorynichMix", "Grapefruit Hentai", "Graphic-Art", "GTA5 Artwork Diffusion", "GuoFeng", "Guohua Diffusion", "HASDX", "Hassanblend", "Healy's Anime Blend", "Hentai Diffusion", "HRL", "ICBINP (I Can't Believe It's Not Photography)", "iCoMix", "Illuminati Diffusion", "Inkpunk Diffusion", "Jim Eidomode", "Juggernaut XL", "JWST Deep Space Diffusion", "Kenshi", "Knollingcase", "Korestyle", "kurzgesagt", "Laolei New Berry Protogen Mix", "Lawlas's yiff mix", "Liberty", "Marvel Diffusion", "Mega Merge Diffusion", "MeinaMix", "Microcasing", "Microchars", "Microcritters", "Microscopic", "Microworlds", "Midjourney Diffusion", "Midjourney PaintArt", "Min Illust Background", "ModernArt Diffusion", "mo-di-diffusion", "Moedel", "MoistMix", "Movie Diffusion", "NeverEnding Dream", "Nitro Diffusion", "Openniji", "OrbAI", "Papercutcraft", "Papercut Diffusion", "Pastel Mix", "Perfect World", "PFG", "pix2pix", "PIXHELL", "Poison", "Pokemon3D", "Pony Diffusion XL", "PortraitPlus", "PPP", "Pretty 2.5D", "PRMJ", "Project Unreal Engine 5", "ProtoGen", "Protogen Anime", "Protogen Infinity", "Pulp Vector Art", "PVC", "Rachel Walker Watercolors", "Rainbowpatch", "Ranma Diffusion", "RCNZ Dumb Monkey", "RCNZ Gorilla With A Brick", "RealBiter", "Realism Engine", "Realistic Vision", "Redshift Diffusion", "Rev Animated", "Robo-Diffusion", "Rodent Diffusion", "RPG", "Samdoesarts Ultmerge", "Sci-Fi Diffusion", "SD-Silicon", "Seek.art MEGA", "Smoke Diffusion", "Something", "Sonic Diffusion", "Spider-Verse Diffusion", "Squishmallow Diffusion", "SDXL 1.0", "Stable Cascade 1.0", "stable_diffusion", "stable_diffusion_2.1", "stable_diffusion_inpainting", "Supermarionation", "Sygil-Dev Diffusion", "Synthwave", "SynthwavePunk", "TrexMix", "trinart", "Trinart Characters", "Tron Legacy Diffusion", "T-Shirt Diffusion", "T-Shirt Print Designs", "Uhmami", "Ultraskin", "UMI Olympus", "Unstable Ink Dream", "URPM", "Valorant Diffusion", "Van Gogh Diffusion", "Vector Art", "vectorartz", "Vintedois Diffusion", "VinteProtogenMix", "Vivid Watercolors", "Voxel Art Diffusion", "waifu_diffusion", "Wavyfusion", "Western Animation Diffusion", "Woop-Woop Photo", "Xynthii-Diffusion", "Yiffy", "Zack3D", "Zeipher Female Model", "Zelda BOTW"]
CivitAI_LoRAs = [
    {"name": "LCM&TurboMix SDXL", "model": 216190, "clip": 1, "is_version": False, "SDXL": True},
    {"name": "LCM-LoRA SDXL", "model": 195519, "clip": 1, "is_version": False, "SDXL": True},
    {"name": "Lightning 8step SDXL", "model": 324115, "clip": 1, "inject_trigger": "HHQR", "is_version": False, "SDXL": True},
    {"name": "Horde Aesthetics Improver", "model": 278377, "clip": 1, "inject_trigger": "HHQR", "is_version": False, "SDXL": False},
    {"name": "blindbox", "model": 25995, "clip": 1, "inject_trigger": "full body, chibi,", "is_version": False, "SDXL": False},
    {"name": "Anime Lineart", "model": 16014, "clip": 1, "inject_trigger": "lineart, monochrome", "is_version": False, "SDXL": False},
    {"name": "GlowingRunesAI", "model": 51686, "clip": 1, "inject_trigger": "GlowingRunes_red", "is_version": False, "SDXL": False},
    {"name": "M_Pixel", "model": 44960, "clip": 1, "inject_trigger": "pixel", "is_version": False, "SDXL": False},
    {"name": "KIDS ILLUSTRATION", "model": 60724, "clip": 1, "inject_trigger": "pixel", "is_version": False, "SDXL": False},
    {"name": "EnvyBetterHands LoCon", "model": 47085, "clip": 1, "inject_trigger": "nice hands, perfect hands", "is_version": False, "SDXL": False},
    {"name": "Middle Finger", "model": 7016, "clip": 1, "inject_trigger": "middle finger", "is_version": False, "SDXL": False},
    {"name": "SteampunkAI", "model": 20830, "clip": 1, "inject_trigger": "steampunkai", "is_version": False, "SDXL": False},
    {"name": "Howls Moving Castle", "model": 14605, "clip": 1, "is_version": False, "SDXL": False},
    {"name": "ConstructionyardAI", "model": 53493, "clip": 1, "inject_trigger": "constructionyardai", "is_version": False, "SDXL": False},
    {"name": "DragonScaleAI", "model": 55543, "clip": 1, "inject_trigger": "Dr490nSc4leAI", "is_version": False, "SDXL": False},
    {"name": "Eye", "model": 5529, "clip": 1, "inject_trigger": "loraeyes", "is_version": False, "SDXL": False},
    {"name": "Anime Screencap", "model": 4982, "clip": 1, "inject_trigger": "anime screencap", "is_version": False, "SDXL": False},
    {"name": "FairyTaleAI", "model": 42260, "clip": 1, "inject_trigger": "fairytaleai", "is_version": False, "SDXL": False},
    {"name": "Stylized 3D", "model": 10679, "clip": 1, "is_version": False, "SDXL": False},
    {"name": "BoneyardAI", "model": 48356, "clip": 1, "inject_trigger": "BoneyardAI", "is_version": False, "SDXL": False},
    {"name": "IvoryGoldAI", "model": 62700, "clip": 1, "inject_trigger": "IvoryGoldAI", "is_version": False, "SDXL": False},
    {"name": "GothicHorrorAI", "model": 39760, "clip": 1, "inject_trigger": "gothichorrorai", "is_version": False, "SDXL": False},
    {"name": "TeslapunkAI", "model": 24150, "clip": 1, "inject_trigger": "teslapunkai", "is_version": False, "SDXL": False},
    {"name": "ValvepunkAI", "model": 24150, "clip": 1, "inject_trigger": "valvepunkai", "is_version": False, "SDXL": False},
    {"name": "OldEgyptAI", "model": 43229, "clip": 1, "inject_trigger": "OldEgyptAI", "is_version": False, "SDXL": False},
    {"name": "CyberpunkAI", "model": 77121, "clip": 1, "inject_trigger": "CyberpunkAI", "is_version": False, "SDXL": False},
    {"name": "Neon CyberpunkAI", "model": 77121, "clip": 1, "inject_trigger": "neon", "is_version": False, "SDXL": False},
    {"name": "DieselpunkAI", "model": 22462, "clip": 1, "inject_trigger": "dieselpunkai", "is_version": False, "SDXL": False},
    {"name": "XSarchitectural-19Houseplan", "model": 26580, "clip": 1, "is_version": False, "SDXL": False},
    {"name": "CircuitBoardAI", "model": 58410, "clip": 1, "inject_trigger": "CircuitBoardAI", "is_version": False, "SDXL": False},
    {"name": "Chinese zodiac", "model": 15246, "clip": 1, "inject_trigger": "animal", "is_version": False, "SDXL": False},
    {"name": "Badass Cars", "model": 54798, "clip": 1, "inject_trigger": "zeekars", "is_version": False, "SDXL": False},
    {"name": "PiratePunkAI", "model": 45892, "clip": 1, "inject_trigger": "piratepunkai", "is_version": False, "SDXL": False},
    {"name": "Vector illustration", "model": 60132, "clip": 1, "inject_trigger": "vector illustration", "is_version": False, "SDXL": False},
    {"name": "Steampunk REDONE", "model": 59338, "clip": 1, "inject_trigger": "SteampunkAI", "is_version": False, "SDXL": False},
    {"name": "CogPunk REDONE", "model": 59338, "clip": 1, "inject_trigger": "CogPunkAI", "is_version": False, "SDXL": False},
    {"name": "BaroqueAI", "model": 38414, "clip": 1, "inject_trigger": "baroqueAI", "is_version": False, "SDXL": False},
    {"name": "TotemPunkAI", "model": 31988, "clip": 1, "inject_trigger": "totempunkai", "is_version": False, "SDXL": False},
    {"name": "GlassTech - World Morph", "model": 57933, "clip": 1, "inject_trigger": "glasstech scifi", "is_version": False, "SDXL": False},
    {"name": "GemstoneAI", "model": 49374, "clip": 1, "inject_trigger": "GemstoneAI", "is_version": False, "SDXL": False},
    {"name": "StreamlinerAI", "model": 23433, "clip": 1, "inject_trigger": "streamlinerai", "is_version": False, "SDXL": False},
    {"name": "SXZ WoW Icons", "model": 45713, "clip": 1, "inject_trigger": "wowicon of", "is_version": False, "SDXL": False},
    {"name": "SolarpunkAI", "model": 43944, "clip": 1, "inject_trigger": "solarpunkai", "is_version": False, "SDXL": False},
    {"name": "Green-PoweredAI", "model": 43944, "clip": 1, "inject_trigger": "green-powered", "is_version": False, "SDXL": False},
    {"name": "StainedGlassAI", "model": 46994, "clip": 1, "inject_trigger": "stainedglassai", "is_version": False, "SDXL": False},
    {"name": "ManyEyedHorrorAI", "model": 47489, "clip": 1, "inject_trigger": "ManyEyedHorrorAI", "is_version": False, "SDXL": False},
    {"name": "NightmarishAI", "model": 56336, "clip": 1, "inject_trigger": "NightmarishAI", "is_version": False, "SDXL": False},
    {"name": "Thicker Lines Anime", "model": 13910, "clip": 1, "is_version": False, "SDXL": False},
    {"name": "3D Rendering", "model": 73756, "clip": 1, "inject_trigger": "3DMM", "is_version": False, "SDXL": False},
    {"name": "epi_noiseoffset", "model": 13941, "clip": 1, "inject_trigger": "dark studio", "is_version": False, "SDXL": False},
    {"name": "Add More Details Enhancer", "model": 82098, "clip": 1, "is_version": False, "SDXL": False},
    {"name": "PDV6XL artist tags", "model": 317578, "clip": 1, "is_version": False, "SDXL": False},
    {"name": "Detail Tweaker", "model": 58390, "clip": 1, "is_version": False, "SDXL": False},
    #{"name": "", "model": , "clip": 1, "inject_trigger": "", "is_version": False, "SDXL": False},
]
