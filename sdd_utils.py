...
Flux_LoRA_models = [
    ...
    {"name": "Hyper-SD-8steps", "path": "ByteDance/Hyper-SD", "weights": "Hyper-FLUX.1-dev-8steps-lora.safetensors", "prefix": ""},
    {"name": "Aesthetic 10k", "path": "advokat/aesthetic-flux-lora-10k", "weights": "aesthetic10k.safetensors", "prefix": ""},
    {"name": "Aesthetic Anime", "path": "dataautogpt3/FLUX-AestheticAnime", "weights": "Flux_1_Dev_LoRA_AestheticAnime.safetensors", "prefix": ""},
    {"name": "Add Details", "path": "Shakker-Labs/FLUX.1-dev-LoRA-add-details", "weights": "FLUX-dev-lora-add_details.safetensors", "prefix": ""},
    {"name": "Cinestill", "path": "adirik/flux-cinestill", "weights": "lora.safetensors", "prefix": "CNSTLL"},
    {"name": "Dark Fantasy Illustration", "path": "nerijs/dark-fantasy-illustration-flux", "weights": "darkfantasy_illustration_v2.safetensors", "prefix": ""},
    {"name": "Gegants", "path": "xaviviro/Flux-Gegants-Lora", "weights": "pytorch_lora_weights.safetensors", "prefix": ""},
    {"name": "Ghibsky Illustration", "path": "aleksa-codes/flux-ghibsky-illustration", "weights": "lora.safetensors", "prefix": "GHIBSKY style"},
    {"name": "LittleTinies", "path": "pzc163/LittleTinies-FLUX-lora", "weights": "pytorch_lora_weights.safetensors", "prefix": ""},
    {"name": "Mix Reality", "path": "bingbangboom/flux_mixReality", "weights": "HIHP_flux_lora_v0_2.safetensors", "prefix": "HIHP style"},
    ...
    {"name": "Fluxlabs Realism", "path": "VideoAditor/Flux-Lora-Realism", "weights": "flux_realism_lora.safetensors", "prefix": ""},
    ...
    {"name": "Silver Metallic 3D Font", "path": "juaner0211/Font_Design_Silver_Metallic_3D_Bold_Font_FLUX", "weights": "j_silver_font_flux_rank16_bf16.safetensors", "prefix": ""},
    ...
    {"name": "Synthetic Anime", "path": "dataautogpt3/FLUX-SyntheticAnime", "weights": "Flux_1_Dev_LoRA_syntheticanime.safetensors", "prefix": "syntheticanime"},
    ...
    {"name": "ASCII Art", "path": "wavymulder/ASCII-flux-LoRA", "weights": "ASCIIart_fluxlora_wavymulder.safetensors", "prefix": "ASCII art"},
    {"name": "Breaking Bad", "path": "markury/breaking-bad-flux", "weights": "pytorch_lora_weights.safetensors", "prefix": ""},
    {"name": "Caravaggio", "path": "ludocomito/flux-lora-caravaggio", "weights": "lora.safetensors", "prefix": "CARAVAGGIO"},
    {"name": "SoftServe Anim", "path": "alvdansen/softserve_anime", "weights": "pytorch_lora_weights.safetensors", "prefix": ""},
    {"name": "Half Illustration", "path": "davisbro/half_illustration", "weights": "flux_train_replicate.safetensors", "prefix": "in the style of TOK"},
    {"name": "Koda", "path": "alvdansen/flux-koda", "weights": "araminta_k_flux_koda.safetensors", "prefix": "flmft style"},
    {"name": "Panorama v2", "path": "jbilcke-hf/flux-dev-panorama-lora-2", "weights": "flux_train_replicate.safetensors", "prefix": "HDRI panoramic view of"},
    {"name": "Paper-Cutout", "path": "Norod78/Flux_1_Dev_LoRA_Paper-Cutout-Style", "weights": "Flux_1_Dev_LoRA_Paper-Cutout-Style.safetensors", "prefix": "Paper Cutout Style"},
    ...
    {"name": "Wrong", "path": "fofr/flux-wrong", "weights": "lora.safetensors", "prefix": "WRNG"},
    {"name": "Yarn Art", "path": "linoyts/yarn_art_Flux_LoRA", "weights": "pytorch_lora_weights.safetensors", "prefix": ", yarn art style"},
    {"name": "Aquarell Watercolor", "path": "SebastianBodza/Flux_Aquarell_Watercolor_v2", "weights": "lora.safetensors", "prefix": "in a watercolor style, AQUACOLTOK. White background."},
    {"name": "Black Myth: Wukong", "path": "wanghaofan/Black-Myth-Wukong-FLUX-LoRA", "weights": "pytorch_lora_weights.safetensors", "prefix": "Wukong"},
    {"name": "Boreal", "path": "kudzueye/Boreal", "weights": "boreal-flux-dev-lora-v04_1000_steps.safetensors", "prefix": "phone photo"},
    {"name": "Realistic-Illustration", "path": "Shakker-Labs/FLUX.1-dev-LoRA-blended-realistic-illustration", "weights": "FLUX-dev-lora-blended_realistic_illustration.safetensors", "prefix": "artistic style blends reality and illustration elements"},
    {"name": "Retrofuturism", "path": "martintomov/retrofuturism-flux", "weights": "retrofuturism_flux_lora_martintomov_v1.safetensors", "prefix": ", retrofuturism"},
    {"name": "Scarlett Johansson", "path": "AINxtGen/ScarlettJohansson_LoRA_FLUX", "weights": "Scarlett_Johansson_lora.safetensors", "prefix": "Scarlett Johansson"},
    {"name": "SyntheticAnime", "path": "dataautogpt3/FLUX-SyntheticAnime", "weights": "Flux_1_Dev_LoRA_syntheticanime.safetensors", "prefix": "1980s anime screengrab, VHS quality"},
    {"name": "Modern Anime", "path": "alfredplpl/flux.1-dev-modern-anime-lora", "weights": "flux.1-dev-modern-anime-lora-2.safetensors", "prefix": "modern anime"},
    {"name": "NSFW Flux", "path": "keepyoursins/nsfw_flux_lora_v1", "weights": "nsfw_flux_lora_v1.safetensors", "prefix": ""},
    {"name": "SCG-Anatomy-NSFW", "path": "john71/SCG-Anatomy-Flux1-d-NSFW-LoRA-for-Flux", "weights": "scg-anatomy-female-v2.safetensors", "prefix": ""},
]
ip_adapter_models = [
